...
action :create do
  ...
  execute "generate-openvpn-#{new_resource.client_name}" do
    ...
    environment(
      ...
      'KEY_DIR'      => key_dir,
      'CA_EXPIRE'    => (new_resource.key_vars['ca_expire'] ? new_resource.key_vars['ca_expire'].to_s : node['openvpn']['key']['ca_expire'].to_s),
      'KEY_EXPIRE'   => (new_resource.key_vars['key_expire'] ? new_resource.key_vars['key_expire'].to_s : node['openvpn']['key']['expire'].to_s),
      'KEY_SIZE'     => (new_resource.key_vars['key_size'] ? new_resource.key_vars['key_size'].to_s : node['openvpn']['key']['size'].to_s),
